      ...
      N("مہرو", "Muhro", [
        ...
        N("بھمبڑ", "Bhambar", [
          N("عوض خان", "Ooaz Khan", [
            N("گوگنا", "Googna", [
              N("محمودہ", "Mehmoda", [
                N("محمد فاروق", "M Farooq", [
                  N("محمد اشفاق", "M Ishfaq", []),
                  N("اشتیاق", "Ishtiaq", []),
                  N("حافظ امتیاز", "Hafiz Imtiaz", []),
                  N("حافظ شہریار", "Hafiz Shahryar", []),
                  N("محمد کیف", "M Kaif", []),
                  N("حسیب", "Haseeb", []),
                  N("محمد آفتاب", "M Aftab", []),
                  N("محمد ایان", "M Ayan", []),
                  N("محمد نعمان", "M Noman", []),
                  N("محمد ارمان", "M Arman", []),
                ]),
                N("عارف", "Arif", [
                  N("فیض", "Faiz", []),
                  N("عمر", "Umar", []),
